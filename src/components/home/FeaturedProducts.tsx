    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-b from-white to-primary-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold mb-3 sm:mb-4 text-gray-900">Our Signature Lashes</h2>
          ...
          {featuredProducts.map((product) => (
            <div key={product.id} className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
              <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4 sm:p-6">
                  <button 
                    ...
                    className="w-full bg-primary-500 text-white py-2 sm:py-3 rounded-full font-medium text-sm sm:text-base transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 hover:bg-primary-600"
                  >
                    Add to Cart
                  </button>
                </div>
              ...
              <div className="p-4 sm:p-5 lg:p-6">
                ...
                <h3 className="text-base sm:text-lg lg:text-xl font-semibold mt-1 mb-2 line-clamp-2">{product.name}</h3>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <Link 
            href="/shop" 
            className="inline-block bg-primary-500 hover:bg-primary-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium text-sm sm:text-base transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            View All Products
          </Link>
        </div>
